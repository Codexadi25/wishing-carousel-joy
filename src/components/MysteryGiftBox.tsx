...
const MysteryGiftBox = () => {
  ...
  const poem = `In the code of this universe, we met in a virtual realm,
      ...
      {!isOpen ? (
        ...
        >
          <div className="relative">
            {/* Gift box */}
            <div className="w-24 h-24 bg-gradient-to-br from-red-500 to-red-600 rounded-lg shadow-xl border-4 border-red-700 flex items-center justify-center">
              <Gift className="w-12 h-12 text-white" />
            </div>
            
            {/* Ribbon */}
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-6 h-24 bg-yellow-400 opacity-80"></div>
            </div>
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-24 h-6 bg-yellow-400 opacity-80"></div>
            </div>
            
            {/* Bow */}
            <div className="absolute -top-2 left-1/2 transform -translate-x-1/2">
              <div className="w-8 h-6 bg-yellow-500 rounded-full"></div>
              <div className="absolute top-1 left-1 w-6 h-4 bg-yellow-400 rounded-full"></div>
            </div>
            
            {/* Sparkle effects */}
            <div className="absolute -top-4 -right-4 text-yellow-300 animate-pulse">✨</div>
            <div className="absolute -bottom-4 -left-4 text-yellow-300 animate-pulse delay-500">✨</div>
          </div>
